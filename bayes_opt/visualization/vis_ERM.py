...
def plot_1d_Forrester_GP_TGP(bo,bo_tgp,fstar=0):
    ...
    temp=np.abs(y_original-fstar)
    idx=np.argmin(temp)
    axis_TGP.hlines(fstar, xmin=bo.bounds[0,0], xmax=bo.bounds[0,1], colors='r', linestyles='solid')
    ...
    axis_TGP.plot(x_original, y_original, linewidth=3, label='f(x)')
    axis_TGP.plot(bo_tgp.X_original.flatten(), bo.Y_original, 'D', markersize=8, label=u'Obs', color='r')
    axis_TGP.plot(x_original, mu_original, '--', color='k', label='$\mu(x)$')
...
def plot_1d_Fourier_GP_TGP(bo,bo_tgp,fstar=0):
    ...
    axis.hlines(fstar, xmin=bo_tgp.bounds[0,0], xmax=bo_tgp.bounds[0,1], colors='r', linestyles='solid')
...
def plot_target_BO_1d(bo,fstar=0):
    ...
    axis.hlines(fstar-5, xmin=bo.bounds[0,0], xmax=bo.bounds[0,1], colors='r', linestyles='solid')
